...
require("myconfig.appearance") --put this at the top because other config files and plugins configure appearance, colorscheme shouldn't overwrite those small local changes.(it will run first then the local changes will run)
